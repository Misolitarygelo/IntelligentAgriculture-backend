...
public class DatabaseInitConfig implements CommandLineRunner {
        ...
        public void run(String... args) throws Exception {
                ...
                try {
                        ...
                        // 删除所有旧表
                        String[] tableNames = {
                                        "irrigation_log", "alert_log", "system_alert_log", "threshold_config",
        ...
        private void createAllTables() {
                ...
                jdbcTemplate.execute(
                                "CREATE TABLE `system_alert_log` (" +
                                                ...
                                                "  `source` VARCHAR(255) COMMENT '告警来源'," +
        ...
        private void insertTestData() {
                ...
                jdbcTemplate.update(
                                "INSERT INTO `sys_user` (`username`, `password`, `real_name`, `role`) VALUES (?, ?, ?, ?)",
                                "farmer1", "$2a$10$N.zmdr9k7uOCQb376NoUnuTJ8iAt6Z5EHsM8lE9lBOsl7iKTVKIUi", "张三",
                                "FARMER");
